...
// Variables
const rootDomain = "xomuhe.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "fionavpn"; // Ganti dengan nama workers kalian
const apiKey = "1ca98f8599e7d165556d9d52ebc718fdc5c0f"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "xomuhe@azuretechtalk.net"; // Ganti dengan email yang kalian gunakan
const accountID = "21e85c79ca96261c2e8e206b7264ac5d"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>FionaVPN</span>");
